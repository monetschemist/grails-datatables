...
<html>
    ...
    <body>
        ...
        <div id="show-office" class="content scaffold-show" role="main">
            ...
            <f:display bean="office" />
            <g:form resource="${this.office}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.office}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
